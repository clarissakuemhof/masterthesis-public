...
class MOPPO(MOPolicy):
    ...
    def get_network_parameters(self):
        ...
        return list(self.networks.parameters())
    ...
    def evaluate_fitness(self):
        """Use the fitness calculated during the task weight selection process"""
        if hasattr(self, 'fitness') and self.fitness is not None:
            print(f"Fitness of the agent: {self.fitness}")
        else:
            raise ValueError("Fitness value is not assigned. Check the task weight selection process.")
